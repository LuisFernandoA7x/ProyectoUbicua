...
List<Product> products = [
  Product(
      ...
      price: GetInformationPrecio('Uniforme1', 'price'),
  ...
  Product(
      ...
      price: GetInformationPrecio('Uniforme2', 'price'),
  ...
  Product(
      ...
      price: GetInformationPrecio('Uniforme3', 'price'),
  ...
  Product(
      ...
      price: GetInformationPrecio('Uniforme4', 'price'),
  ...
  Product(
      ...
      price: GetInformationPrecio('Uniforme5', 'price'),
  ...
  Product(
    ...
    price: GetInformationPrecio('Uniforme6', 'price'),
